...
public class TableInDataSetConstraintEnumeration implements ConstraintEnumeration
{
		...
		throws InvalidSchemaException
	{
		...
		AdaptationTable table = getTable(getDataSet(context), tableName);
		if (table == null)
		{
			context.addError(tableName + " is not a the name of a table.");
		}
	}
