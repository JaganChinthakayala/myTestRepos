...
/**
 */
public class ProjectWorkflowConstants extends WorkflowConstants
{
	...
	public static final String SESSION_PARAM_DOMAIN = PARAM_DOMAIN;

	public static final String PERMISSIONS_USER_PROJECT_TYPE_PREFIX = "ProjectType_";

	protected ProjectWorkflowConstants()
	{
		// do nothing
	}
}
