...
public abstract class SubjectStatusEditor extends ReadOnlyUIBeanEditor
{
	...
	protected Nomenclature createNomenclature(String currentStatus)
	{
		// This assumes status is required. If it's not for some reason, we should add an empty nomenclature.
