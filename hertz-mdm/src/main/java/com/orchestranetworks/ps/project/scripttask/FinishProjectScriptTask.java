...
public abstract class FinishProjectScriptTask extends ScriptTask implements ProjectPathCapable
{
	...
	protected void updateSubjectStatus(
		...
		String currentStatus) throws OperationException
	{
		// do nothing
	}
	...
	protected void updateProjectAndSubjectStatus(ProcedureContext pContext, Adaptation projectRecord)
		throws OperationException
	{
		...
		Path projectSubjectsPath = projectPathConfig.getProjectProjectSubjectsFieldPath(projectType);
	...
	private static Adaptation doModify(
		...
		ValueContextForUpdate vc) throws OperationException
	{
