...
/**
 * A functor that takes two arguments and returns an <code>Object</code> value. <p/> Implementors are encouraged but not
 * required to make their functors {@link java.io.Serializable Serializable}. </p>
 * 
