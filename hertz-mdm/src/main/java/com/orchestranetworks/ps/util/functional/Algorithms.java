...
public class Algorithms
{
	...
	{
		List<O> result = new ArrayList<O>(collection.size());
	...
	{
		List<O> result = new ArrayList<O>(objects.length);
	 ...
	 * {@link Generator} limits. For example: <p/> <pre> EachLine.open(file).until(new MaxIterations(1)); </pre> <p/>
