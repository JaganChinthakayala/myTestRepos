...
/**
 * A functor that takes one argument and returns a <code>boolean</code> value. <p/> Implementors are encouraged but not
...
public abstract class UnaryPredicate<T>
{
	...
	public static UnaryPredicate<Object> isEqual(final Object equalsThis)
	{
		return new UnaryPredicate<Object>()
		{
			...
			public boolean test(Object object)
			{
				return ObjectUtils.equals(object, equalsThis);
			}
