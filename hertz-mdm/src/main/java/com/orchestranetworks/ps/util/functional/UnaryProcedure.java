...
/**
 * A functor that takes one argument and returns no value. <p/> Implementors are encouraged but not required to make
 * their functors {@link java.io.Serializable Serializable}. </p> credit: org.apache.commons.functor. copied to extend
...
public abstract class UnaryProcedure<T>
{
	...
	{
		return new BoundProcedure<T>(this, value);
	}
