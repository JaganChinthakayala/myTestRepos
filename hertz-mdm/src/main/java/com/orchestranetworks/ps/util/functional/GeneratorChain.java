...
public final class GeneratorChain<T> extends Generator<T>
{
	...
	private final Collection<Generator<T>> generators = new ArrayList<Generator<T>>();
	...
	{
		return new GeneratorChain<T>(generators);
	}
	...
	{
		return new GeneratorChain<T>(generator1, generator2);
	}
}
