...
public class OptionsPane implements UIFormPane
{
	...
	public void writePane(UIFormPaneWriter pWriter, UIFormContext pContext)
	{
		...
		{
			pWriter.addFormRow(VehicleReferencePaths._Root_ChromeNewVehicleData_Styles._Root_ChromeNewVehicleData_Styles_Options);
		}
