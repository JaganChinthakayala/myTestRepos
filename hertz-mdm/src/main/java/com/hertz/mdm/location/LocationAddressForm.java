...
public final class LocationAddressForm
{
	...
	public static GoogleMapsAddressFieldMapping getLocationGoogleMapsMapping()
	{
		...
		mapping.setNumberPath(LocationPaths._Root_LocationData_Address._Address_StreetNumber);
		mapping.setStreetPath(LocationPaths._Root_LocationData_Address._Address_AddressLine1);
		mapping.setCountryPath(LocationPaths._Root_LocationData_Address._Address_Country);
		mapping.setZipcodePath(LocationPaths._Root_LocationData_Address._Address_PostalCode);
		mapping.setCityPath(LocationPaths._Root_LocationData_Address._Address_City);
		mapping.setRegionPath(LocationPaths._Root_LocationData_Address._Region);
		...
		mapping.setLatitudePath(LocationPaths._Root_LocationData_Address._GeographicPoint_Latitude);
		mapping
			.setLongitudePath(LocationPaths._Root_LocationData_Address._GeographicPoint_Longitude);
