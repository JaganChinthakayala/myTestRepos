...
public class HierarchyNodeAccessRule implements AccessRule
{
	@Override
	public AccessPermission getPermission(Adaptation adaptation, Session session, SchemaNode node)
	{
		...
		String hierarchyNodeType = hierarchyStructureDefinitionRecord
			.getString(LocationPaths._Root_LocationHierarchy._HierarchyNodeType);
