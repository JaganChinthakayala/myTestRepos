...
/**
 */
public class LocationServiceHoursTrigger extends BaseTableTrigger
{
	@Override
	public void handleAfterCreate(AfterCreateOccurrenceContext context) throws OperationException
	{
		Adaptation serviceDaysRecord = AdaptationUtil.followFK(
		...
		Adaptation locationRecord = AdaptationUtil
			.followFK(serviceDaysRecord, LocationPaths._Root_LocationData_ServiceDays._Location);
	...
	public void handleAfterDelete(AfterDeleteOccurrenceContext context) throws OperationException
	{
		...
		Adaptation serviceDaysRecord = AdaptationUtil
			.followFK(valueContext, LocationPaths._Root_LocationData_ServiceHours._ServiceDays);
