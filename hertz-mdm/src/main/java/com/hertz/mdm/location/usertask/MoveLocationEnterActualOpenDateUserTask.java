...
/**
 */
public class MoveLocationEnterActualOpenDateUserTask extends MoveLocationProjectMaintenanceUserTask
{
	@Override
	public void checkBeforeWorkItemCompletion(UserTaskBeforeWorkItemCompletionContext context)
	{
		...
		if (context.isAcceptAction())
		{
			...
			checkFieldRequired(
				context,
				projectRecord,
				LocationPaths._Root_LocationProject._MoveLocation_NewLocation_ActualOpenDate,
				true,
				true);
		}
