...
public class LocationMinimumAgeForRentalValueFunction implements ValueFunction
{
	@Override
	public Object getValue(Adaptation adaptation)
	{
		...
		{
			return LocationConstants.LOCATION_DEFAULT_MINIMUM_RENTAL_AGE;
		}
		else
		{
			return countryMinimumMaximumAgeRecord
				.get(LocationReferencePaths._Root_CountryMinimumMaximumAge._MinimunAge)
				.toString();
		}
	}
